...
import { nonVegPickles } from "../../data/menu";
  ...
  return (
    <section id="non-veg" className="relative py-24 md:py-32 px-6 md:px-12" data-testid="nonveg-section">
      <div className="max-w-6xl mx-auto">
        ...
        />
        <p
          className="-mt-10 mb-14 text-sm md:text-base italic text-nirmala-muted"
          data-testid="nonveg-boneless-note"
        >
          All chicken &amp; mutton pickles are 100% boneless.
        </p>
          ...
          {nonVegPickles.map((item, idx) => (
            ...
            >
              ...
              <div className="flex items-end justify-between pt-5 border-t border-nirmala-divider">
                ...
                <span className="text-xs uppercase tracking-[0.24em] text-nirmala-muted group-hover:text-nirmala-gold transition-colors">
                  View →
                </span>
              </div>
            </button>
